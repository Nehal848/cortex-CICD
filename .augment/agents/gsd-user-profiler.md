...
<reference>
@D:/Projects/CortexCICD/Self-Healing-CI-CD/.augment/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `D:/Projects/CortexCICD/Self-Healing-CI-CD/.augment/get-shit-done/references/user-profiling.md` to load:
