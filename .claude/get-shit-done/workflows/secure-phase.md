...
```
Agent(
  prompt="Read D:/Projects/CortexCICD/Self-Healing-CI-CD/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Projects/CortexCICD/Self-Healing-CI-CD/.claude/get-shit-done/templates/SECURITY.md`
