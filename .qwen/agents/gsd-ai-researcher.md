...
<required_reading>
Read `D:/Projects/CortexCICD/Self-Healing-CI-CD/.qwen/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
