...
INSTALL_JS_GLOBAL="D:/Projects/CortexCICD/Self-Healing-CI-CD/.kilo/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node D:/Projects/CortexCICD/Self-Healing-CI-CD/.kilo/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
