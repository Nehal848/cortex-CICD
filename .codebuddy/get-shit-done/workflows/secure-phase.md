...
```
Agent(
  prompt="Read D:/Projects/CortexCICD/Self-Healing-CI-CD/.codebuddy/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Projects/CortexCICD/Self-Healing-CI-CD/.codebuddy/get-shit-done/templates/SECURITY.md`
