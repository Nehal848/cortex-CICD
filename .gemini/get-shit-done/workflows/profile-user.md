...
Key references:
- @D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/get-shit-done/references/ui-brand.md (display patterns)
- @D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/agents/gsd-user-profiler.md (profiler agent definition)
- @D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/get-shit-done/USER-PROFILE.md"
...
```bash
cp "D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/get-shit-done/USER-PROFILE.md" "D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/USER-PROFILE.backup.md"
```
...
✓ Stores profile at D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/get-shit-done/references/user-profiling.md`
...
Reference: @D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/CLAUDE.md"
...
```bash
BACKUP_PATH="D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/USER-PROFILE.backup.md"
```
...
Your profile:    D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        D:/Projects/CortexCICD/Self-Healing-CI-CD/.gemini/CLAUDE.md
```
