...
```
Agent(
  prompt="Read D:/Projects/CortexCICD/Self-Healing-CI-CD/.kilo/agents/gsd-nyquist-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `D:/Projects/CortexCICD/Self-Healing-CI-CD/.kilo/get-shit-done/templates/VALIDATION.md`
