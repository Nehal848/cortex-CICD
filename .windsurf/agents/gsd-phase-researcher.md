...
@D:/Projects/CortexCICD/Self-Healing-CI-CD/.windsurf/get-shit-done/references/thinking-models-research.md
...
```bash
node "D:/Projects/CortexCICD/Self-Healing-CI-CD/.windsurf/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
