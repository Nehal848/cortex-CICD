...
```markdown
Read D:/Projects/CortexCICD/Self-Healing-CI-CD/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: D:/Projects/CortexCICD/Self-Healing-CI-CD/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read D:/Projects/CortexCICD/Self-Healing-CI-CD/.claude/agents/gsd-ui-checker.md for instructions.
