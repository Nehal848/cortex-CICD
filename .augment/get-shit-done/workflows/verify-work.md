...
<template>
@D:/Projects/CortexCICD/Self-Healing-CI-CD/.augment/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@D:/Projects/CortexCICD/Self-Healing-CI-CD/.augment/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `D:/Projects/CortexCICD/Self-Healing-CI-CD/.augment/get-shit-done/workflows/transition.md`.
...
- Follow @D:/Projects/CortexCICD/Self-Healing-CI-CD/.augment/get-shit-done/workflows/diagnose-issues.md
