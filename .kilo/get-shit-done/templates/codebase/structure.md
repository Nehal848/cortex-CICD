...
- Usage: Reference from command with `@D:/Projects/CortexCICD/Self-Healing-CI-CD/.kilo/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to D:/Projects/CortexCICD/Self-Healing-CI-CD/.kilo/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to D:/Projects/CortexCICD/Self-Healing-CI-CD/.kilo/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
