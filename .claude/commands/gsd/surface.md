...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/Projects/CortexCICD/Self-Healing-CI-CD/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=D:/Projects/CortexCICD/Self-Healing-CI-CD/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=D:/Projects/CortexCICD/Self-Healing-CI-CD/.claude/commands/gsd
AGENTS_DIR=D:/Projects/CortexCICD/Self-Healing-CI-CD/.claude/agents
```
...
<execution_context>
Surface state file: `D:/Projects/CortexCICD/Self-Healing-CI-CD/.claude/skills/.gsd-surface.json`
Install profile marker: `D:/Projects/CortexCICD/Self-Healing-CI-CD/.claude/skills/.gsd-profile`
Engine module: `D:/Projects/CortexCICD/Self-Healing-CI-CD/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `D:/Projects/CortexCICD/Self-Healing-CI-CD/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
