...
@D:/Projects/CortexCICD/Self-Healing-CI-CD/.qwen/get-shit-done/references/git-integration.md
</required_reading>
...
See `D:/Projects/CortexCICD/Self-Healing-CI-CD/.qwen/get-shit-done/references/tdd.md` for structure.
</tdd_plan_execution>
...
See D:/Projects/CortexCICD/Self-Healing-CI-CD/.qwen/get-shit-done/references/checkpoints.md for details.
</step>
...
Create `{phase}-{plan}-SUMMARY.md` at `.planning/phases/XX-name/`. Use `D:/Projects/CortexCICD/Self-Healing-CI-CD/.qwen/get-shit-done/templates/summary.md`.
