...
<required_reading>
@D:/Projects/CortexCICD/Self-Healing-CI-CD/.augment/get-shit-done/references/ai-frameworks.md
@D:/Projects/CortexCICD/Self-Healing-CI-CD/.augment/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read D:/Projects/CortexCICD/Self-Healing-CI-CD/.augment/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "D:/Projects/CortexCICD/Self-Healing-CI-CD/.augment/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read D:/Projects/CortexCICD/Self-Healing-CI-CD/.augment/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read D:/Projects/CortexCICD/Self-Healing-CI-CD/.augment/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read D:/Projects/CortexCICD/Self-Healing-CI-CD/.augment/agents/gsd-eval-planner.md for instructions.
