...
Reference full template: `D:/Projects/CortexCICD/Self-Healing-CI-CD/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `D:/Projects/CortexCICD/Self-Healing-CI-CD/get-shit-done/templates/state.md`.
