...
<!-- For checkpoint task examples and patterns, see @D:/Projects/CortexCICD/Self-Healing-CI-CD/.windsurf/get-shit-done/references/checkpoints.md -->
...
See `D:/Projects/CortexCICD/Self-Healing-CI-CD/.windsurf/get-shit-done/references/tdd.md` for TDD plan structure.
...
See `D:/Projects/CortexCICD/Self-Healing-CI-CD/.windsurf/get-shit-done/templates/user-setup.md` for full schema and examples
...
See `D:/Projects/CortexCICD/Self-Healing-CI-CD/.windsurf/get-shit-done/workflows/verify-phase.md` for verification logic.
