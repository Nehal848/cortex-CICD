...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `D:/Projects/CortexCICD/Self-Healing-CI-CD/.qwen/skills/.gsd-surface.json`
...
```bash
# Qwen Code
RUNTIME_CONFIG_DIR=D:/Projects/CortexCICD/Self-Healing-CI-CD/.qwen/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=D:/Projects/CortexCICD/Self-Healing-CI-CD/.qwen/commands/gsd
AGENTS_DIR=D:/Projects/CortexCICD/Self-Healing-CI-CD/.qwen/agents
```
...
<execution_context>
Surface state file: `D:/Projects/CortexCICD/Self-Healing-CI-CD/.qwen/skills/.gsd-surface.json`
Install profile marker: `D:/Projects/CortexCICD/Self-Healing-CI-CD/.qwen/skills/.gsd-profile`
Engine module: `D:/Projects/CortexCICD/Self-Healing-CI-CD/.qwen/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `D:/Projects/CortexCICD/Self-Healing-CI-CD/.qwen/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
