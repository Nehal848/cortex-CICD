...
```bash
INIT=$(node "D:/Projects/CortexCICD/Self-Healing-CI-CD/.kilo/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "D:/Projects/CortexCICD/Self-Healing-CI-CD/.kilo/get-shit-done/bin/gsd-tools.cjs" commit \
