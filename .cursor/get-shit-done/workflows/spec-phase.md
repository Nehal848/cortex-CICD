...
```bash
INIT=$(node "D:/Projects/CortexCICD/Self-Healing-CI-CD/.cursor/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @D:/Projects/CortexCICD/Self-Healing-CI-CD/.cursor/get-shit-done/templates/spec.md.
