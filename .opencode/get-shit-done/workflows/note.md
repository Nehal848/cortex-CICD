...
- **Global scope**: `D:/Projects/CortexCICD/Self-Healing-CI-CD/.opencode/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/Projects/CortexCICD/Self-Healing-CI-CD/.opencode/notes/`)
...
2. Glob `D:/Projects/CortexCICD/Self-Healing-CI-CD/.opencode/notes/*.md` (if directory exists) — global notes
...
Global (D:/Projects/CortexCICD/Self-Healing-CI-CD/.opencode/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/Projects/CortexCICD/Self-Healing-CI-CD/.opencode/notes/` — works in any directory
