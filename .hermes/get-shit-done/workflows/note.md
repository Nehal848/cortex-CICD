...
- **Global scope**: `D:/Projects/CortexCICD/Self-Healing-CI-CD/.hermes/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `D:/Projects/CortexCICD/Self-Healing-CI-CD/.hermes/notes/`)
...
2. Glob `D:/Projects/CortexCICD/Self-Healing-CI-CD/.hermes/notes/*.md` (if directory exists) — global notes
...
Global (D:/Projects/CortexCICD/Self-Healing-CI-CD/.hermes/notes/):
...
2. **No `.planning/`**: Falls back to global `D:/Projects/CortexCICD/Self-Healing-CI-CD/.hermes/notes/` — works in any directory
