...
Use template from `D:/Projects/CortexCICD/Self-Healing-CI-CD/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `D:/Projects/CortexCICD/Self-Healing-CI-CD/.claude/get-shit-done/templates/UI-SPEC.md`
